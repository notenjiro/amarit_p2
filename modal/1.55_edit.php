    ...
    <form action="" method="POST" role="form" id="roleList_data">
        <div class="row d-flex flex-column">  
            <div class="col-12 d-flex" > 
                ...
                <div class="form-group d-flex align-items-center justify-content-between col-6">
                    <b>Date</b>
                    <input required type="date" name="date" id="date" class="form-control col-10">
                </div> 
            </div>
   ...
   $("#roleList_data").submit(function(e) {
    ...
    function insert_data(data){
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: 'api/insert_cut_off_account.php',
            data: data,
    ...
    function load_type(id){
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: 'api/get_cut_off_account.php?id='+id,
            success: function(res) {
                if(res.data){
                    $('#roleid').val(id);
