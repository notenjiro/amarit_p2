...
<div class="modal-body">
    <form id="contract_data">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-inline">
                        ...
                        <input type="number" name="payment_term" id="payment_term" class="form-control w-5"
                            style="text-align:right;">&nbsp;Days
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-inline">
                        <label>Round trip rate %</label>&nbsp;
                        <input type="number" name="round_trip_rate" id="round_trip_rate" class="form-control w-5"
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            <lavel>If Diesel price does exceed THB <input type="number" name="diesel1" id="diesel1"
                                    class="form-control w-5" style="text-align:right" step="0.01"> per liter then a
                                <input type="number" name="diesel2" id="diesel2" class="form-control w-5"
                                    style="text-align:right;" step="0.01"> % increse in our charge rate per unit will be
                                applied for every THB <input type="number" name="diesel3" id="diesel3"
                                    class="form-control w-5" style="text-align:right;" step="0.01"> increase in the
                                Diesal price.</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <button style="width:100px" type="submit" class="btn btn-success" id="contract_submit"
                    data-bs-target="#">
                    <i class="fa fa-save"></i> Save
                </button>
                <button style="width:100px" type="button" class="btn btn-danger" id="contract_cancel"
                    data-bs-target="#">
    ...
    <div id="sub_data">
        <div class="card-body">
            <ul class="nav nav-tabs" role="tablist" id="menu-contract">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#transportation-tab" id="transportation-nav">TP
                        Format 1 ( <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#service-tab" id="service-nav">TP Format 2 (
                        <span></span> )</a>
                </li>
                <!--<li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#heavy-tab" id="heavy-nav">Cargo handling (
                        <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#hourly-tab" id="hourly-nav">Manpower ( <span></span>
                        )</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#warehouse-tab" id="warehouse-nav">Warehouse (
                        <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#utilities-tab" id="utilities-nav">Utilities (
                        <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#retal-tab" id="retal-nav">Retal (Vehicle & Heavy Eq) (
                        <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#customerclearancecargo-tab"
                        id="customerclearancecargo">Customer Clearance ( Cargo ) ( <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#customerclearancevessle-tab"
                        id="customerclearancevessle">Customer Clearance ( Vessel ) ( <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#hotelbooking-tab" id="hotelbooking-nav">Hotel Booking (
                        <span></span> )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#ticketbooking-tab" id="ticketbooking-nav">Ticket
                        Booking ( <span></span> )</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#managementfee-tab" id="managementfee">Management fee (
                        <span></span> )</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content pt-4">
                        ...
                        <div id="transportation_edit_area">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contract_line1" id="contract_line1"
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub1" id="transport_sub1" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type1, sub_type1, WH FROM FES.dbo.barcode_sub_type1 where TP = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub2</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub2" id="transport_sub2" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type2, sub_type2, WH FROM FES.dbo.barcode_sub_type2 where TP = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub3</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub3" id="transport_sub3" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub4</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub4" id="transport_sub4" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type4, sub_type4, WH FROM FES.dbo.barcode_sub_type4 where TP = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub5</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub5" id="transport_sub5" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub6" id="transport_sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6, WH FROM FES.dbo.barcode_sub_type6 where TP = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="transportation_uom" id="transportation_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <select name="barcode_type" id="transportation_barcode_type" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, UT FROM FES.dbo.barcode_product_type where TP = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="diesel_baht_from" id="diesel_baht_from"
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="diesel_baht_to" id="diesel_baht_to"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="transportation_from" id="transportation_from" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="transportation_to" id="transportation_to" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM contract_location_master where active = 1 order by location";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="transportation_rate" id="transportation_rate"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total_km" id="total_km" class="form-control"
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="transport_category" id="transport_category"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="transportation_round_trip_rate"
                                            id="transportation_round_trip_rate" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                    ...
                    <table id="transportation_table" class="table table-striped display nowrap" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" width="10%">Round trip rate </th>
                ...
                <div class="tab-pane fade" id="service-tab">
                    <form id="service_data">
                        <div id="service_edit_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="contract_line2" id="contract_line2"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub5</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub5" id="sub5" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type5, sub_type5, TP FROM FES.dbo.barcode_sub_type5 where TP = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub6" id="sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6, WH FROM FES.dbo.barcode_sub_type6 where TP = 1";
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="barcode_type" id="service_barcode_type" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, UT FROM FES.dbo.barcode_product_type where TP = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="daily_rate" id="daily_rate" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="monthly_rate" id="monthly_rate" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="minimum_charge_hour2" id="minimum_charge_hour2"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" value="1" id="transport_solution2"
                                            name="transport_solution2" class="form-check">
                                    </div>
                                </div>
                                <!-- <div class="col-2">   
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ot_rate_hour" id="ot_rate_hour" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference</span><span style="color:red"> *</span>
                                        <input type="text" name="customerref" id="transport_customerref"
                                            class="form-control" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" style="width:100px" class="btn btn-success" id="service_add"
                                    data-bs-target="#">
                                    <i class="fa fa-plus-square"></i> Add
                                </button>

                                <button type="submit" style="width:100px" class="btn btn-success" id="service_submit"
                                    data-bs-target="#">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger" id="service_cancel"
                                    data-bs-target="#">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <table id="service_table" class="table table-striped display nowrap" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" width="10%">Transport solution</th>
                                <th scope="col" width="10%">OT rate/ hour</th>
                                <th scope="col" width="10%">Customer reference </th>
                                <th scope="col" width="10%">sub1</th>
                                <th scope="col" width="10%">sub2</th>
                                <th scope="col" width="10%">sub3</th>
                ...
                <div class="tab-pane fade" id="serviceat-tab">
                    <form id="serviceat_data">
                        <div id="serviceat_edit_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="contract_line3" id="contract_line3"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select name="commute_range" id="commute_range" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Transport solution</span>
                                        <input type="checkbox" value="1" id="transport_solution3"
                                            name="transport_solution3" class="form-check">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel baht from</span><span style="color:red"> *</span>
                                        <input type="text" name="diesel_baht_from" id="serviceat_diesel_baht_from"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel baht to</span><span style="color:red"> *</span>
                                        <input type="text" name="diesel_baht_to" id="serviceat_diesel_baht_to"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="one_way" id="one_way" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="round_trip" id="round_trip" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" style="width:100px" class="btn btn-success" id="serviceat_add"
                                    data-bs-target="#">
                                    <i class="fa fa-plus-square"></i> Add
                                </button>

                                <button type="submit" style="width:100px" class="btn btn-success" id="serviceat_submit"
                                    data-bs-target="#">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger" id="serviceat_cancel"
                                    data-bs-target="#">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                ...
                <div class="tab-pane fade" id="heavy-tab">
                    <form id="heavy_data">
                        <div id="heavy_edit_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="contract_line4" id="contract_line4"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Location</span><span style="color:red"> *</span>
                                        <select name="heavy_branch" id="heavy_branch" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM contract_location_master where active = 1 order by location";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub1" id="sub1" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type1, sub_type1, CH FROM FES.dbo.barcode_sub_type1 where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type1']; ?>">
                                                    <?php echo $row['sub_type1'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub2" id="sub2" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type2, sub_type2, CH FROM FES.dbo.barcode_sub_type2 where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type2']; ?>">
                                                    <?php echo $row['sub_type2'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub3" id="sub3" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type3, sub_type3, CH FROM FES.dbo.barcode_sub_type3 where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type3']; ?>">
                                                    <?php echo $row['sub_type3'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub4" id="sub4" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type4, sub_type4, CH FROM FES.dbo.barcode_sub_type4 where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type4']; ?>">
                                                    <?php echo $row['sub_type4'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub6" id="sub6" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6, CH FROM FES.dbo.barcode_sub_type6 where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type6']; ?>">
                                                    <?php echo $row['sub_type6'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="heavy_uom" id="heavy_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="barcode_type" id="heavy_barcode_type" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, UT FROM FES.dbo.barcode_product_type where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <span>Vehicle type</span><span style="color:red"> *</span>
                                        <select name="heavy_equipment" id="heavy_equipment" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM vehicle_type order by code";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel baht from</span><span style="color:red"> *</span>
                                        <input type="text" name="diesel_baht_from" id="heavy_diesel_baht_from"
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel baht to</span><span style="color:red"> *</span>
                                        <input type="text" name="diesel_baht_to" id="heavy_diesel_baht_to"
                                            style="text-align:right;" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum hour</span><span style="color:red"> *</span>
                                        <input type="text" name="minimum_charge_hour" id="minimum_charge_hour"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="day_rate" id="day_rate" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ton_rate" id="ton_rate" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Customer reference</span><span style="color:red"> *</span>
                                        <input type="text" name="customeref" id="customeref" class="form-control"
                                            required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" style="width:100px" class="btn btn-success" id="heavy_add"
                                    data-bs-target="#">
                                    <i class="fa fa-plus-square"></i> Add
                                </button>

                                <button type="submit" style="width:100px" class="btn btn-success" id="heavy_submit"
                                    data-bs-target="#">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger" id="heavy_cancel"
                                    data-bs-target="#">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                ...
                <div class="tab-pane fade" id="hourly-tab">
                    <form id="hourly_data">
                        <div id="hourly_edit_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="contract_line_number" id="hourly_contract_line_number"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description" id="hourly_description"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Name</span><span style="color:red"> *</span>
                                        <select name="name" id="hourly_name" class="form-control"
                                            aria-describedby="inputGroupPrepend2" onchange="changeLocation(id)"
                                            required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <select name="barcode_branch" id="hourly_barcode_branch" class="form-control"
                                            aria-describedby="inputGroupPrepend2" onchange="changeLocation(id)"
                                            required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Location</span><span style="color:red"> *</span>
                                        <select name="barcode_location" id="hourly_barcode_location"
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub1</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub1" id="hourly_sub1" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type1, sub_type1, CH FROM FES.dbo.barcode_sub_type1 where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type1']; ?>">
                                                    <?php echo $row['sub_type1'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub2</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub2" id="hourly_sub2" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type2, sub_type2, CH FROM FES.dbo.barcode_sub_type2 where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type2']; ?>">
                                                    <?php echo $row['sub_type2'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub3</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub3" id="hourly_sub3" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type3, sub_type3, CH FROM FES.dbo.barcode_sub_type3 where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type3']; ?>">
                                                    <?php echo $row['sub_type3'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub4</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub4" id="hourly_sub4" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type4, sub_type4, CH FROM FES.dbo.barcode_sub_type4 where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type4']; ?>">
                                                    <?php echo $row['sub_type4'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub5</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub5" id="hourly_sub5" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type5, sub_type5, CH FROM FES.dbo.barcode_sub_type5 where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type5']; ?>">
                                                    <?php echo $row['sub_type5'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub6" id="hourly_sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6, CH FROM FES.dbo.barcode_sub_type6 where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type6']; ?>">
                                                    <?php echo $row['sub_type6'] ?>
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_type" id="manpower_barcode_type" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, UT FROM FES.dbo.barcode_product_type where LS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="manpower_position" id="manpower_position"
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select name="universal_position" id="universal_position" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="after_normal" id="after_normal" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <span>Day off - Regular Rate/hour</span><span style="color:red"> *</span>
                                        <input type="text" name="s_normal" id="s_normal" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <span>Day off - OT Rate/hour</span><span style="color:red"> *</span>
                                        <input type="text" name="s_after_normal" id="s_after_normal"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="minimum_charge" id="minimum_charge"
                            ...
                            <div class="row">
                                <div class="col-2 close_st">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="start_ship" id="start_ship" class="form-control"
                                            required>
                                    </div>
                                </div>
                                <div class="col-2 close_st">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ot_lamsam" id="ot_lamsam" class="form-control"
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sunday_lamsam" id="sunday_lamsam" class="form-control"
                                            style="text-align:right;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <div class="form-group">
                                        <span>Wed</span>
                                        <input type="checkbox" value="1" id="wednesday" name="wednesday"
                                            class="form-check">
                                    </div>
                                </div>
                                <div class="col-1">
                                    <div class="form-group">
                                        <span>Thu</span>
                                        <input type="checkbox" value="1" id="thursday" name="thursday"
                                            class="form-check">
                                    </div>
                                </div>
                                <div class="col-1">
                                ...
                                <div class="col-1">
                                    <div class="form-group">
                                        <span>Sat</span>
                                        <input type="checkbox" value="1" id="saturday" name="saturday"
                                            class="form-check">
                                    </div>
                                </div>
                                <div class="col-1">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lamsum_charge_rate" id="lamsum_charge_rate"
                                            class="form-control" style="text-align:right;">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" style="width:100px" class="btn btn-success" id="hourly_add"
                                    data-bs-target="#">
                                    <i class="fa fa-plus-square"></i> Add
                                </button>

                                <button type="submit" style="width:100px" class="btn btn-success" id="hourly_submit"
                                    data-bs-target="#">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger" id="hourly_cancel"
                                    data-bs-target="#">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                ...
                <div class="tab-pane fade" id="promotion-tab">
                    <form id="promotion_data">
                        <div id="promotion_edit_area">
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="promotion_contract_line" id="promotion_contract_line"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Description</span><span style="color:red"> *</span>
                                        <input type="text" name="promotion_description" id="promotion_description"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="promotion_discount" id="promotion_discount"
                                            class="form-control" style="text-align:right;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" style="width:100px" class="btn btn-success" id="promotion_add"
                                    data-bs-target="#">
                                    <i class="fa fa-plus-square"></i> Add
                                </button>

                                <button type="submit" style="width:100px" class="btn btn-success" id="promotion_submit"
                                    data-bs-target="#">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger" id="promotion_cancel"
                                    data-bs-target="#">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                        ...
                        <div id="taxi_edit_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="taxi_contract_line" id="taxi_contract_line"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <span>Description</span><span style="color:red"> *</span>
                                        <input type="text" name="taxi_description" id="taxi_description"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="name" id="transport_name" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, TP FROM FES.dbo.barcode_service where PT = 1 ";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_service']; ?>">
                                                    <?php echo $row['type_service_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="location" id="transport_branch" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="location" id="transport_location" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, TP FROM FES.dbo.barcode_location where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_location']; ?>">
                                                    <?php echo $row['location_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub1" id="sub1" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type1, sub_type1, WH FROM FES.dbo.barcode_sub_type1 where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type1']; ?>">
                                                    <?php echo $row['sub_type1'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub2" id="sub2" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type2, sub_type2, WH FROM FES.dbo.barcode_sub_type2 where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type2']; ?>">
                                                    <?php echo $row['sub_type2'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub3" id="sub3" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type3, sub_type3, TP FROM FES.dbo.barcode_sub_type3 where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type3']; ?>">
                                                    <?php echo $row['sub_type3'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub4" id="sub4" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type4, sub_type4, WH FROM FES.dbo.barcode_sub_type4 where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type4']; ?>">
                                                    <?php echo $row['sub_type4'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub5" id="sub5" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type5, sub_type5, TP FROM FES.dbo.barcode_sub_type5 where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type5']; ?>">
                                                    <?php echo $row['sub_type5'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub6" id="sub6" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6, WH FROM FES.dbo.barcode_sub_type6 where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type6']; ?>">
                                                    <?php echo $row['sub_type6'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="taxi_uom" id="taxi_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_type" id="taxi_barcode_type" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, UT FROM FES.dbo.barcode_product_type where PT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Vehicle type</span><span style="color:red"> *</span>
                                        <select name="taxi_vehicle_type" id="taxi_vehicle_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM vehicle_type order by code";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="taxi_rate" id="taxi_rate" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Total KM.</span><span style="color:red"> *</span>
                                        <input type="text" name="taxi_total_km" id="taxi_total_km" class="form-control"
                                            style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel baht from</span><span style="color:red"> *</span>
                                        <input type="text" name="taxi_diesel_baht_from" id="taxi_diesel_baht_from"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel baht to</span><span style="color:red"> *</span>
                                        <input type="text" name="taxi_diesel_baht_to" id="taxi_diesel_baht_to"
                                            class="form-control" style="text-align:right;" required>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="immigration-tab">
                    <form id="immigration_data">
                        <div id="immigration_edit_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span><span style="color:red"> *</span>
                                        <input type="text" name="immigration_contract_line"
                                            id="immigration_contract_line" class="form-control" required>
                                    </div>
                                </div> 
                                 <div class="col-3">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="name" id="transport_name" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, TP FROM FES.dbo.barcode_service where IM = 1 ";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_service']; ?>">
                                                    <?php echo $row['type_service_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="location" id="transport_branch" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Location</span><span style="color:red"> *</span>
                                        <select name="immigration_location" id="immigration_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub1" id="sub1" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type1, sub_type1, WH FROM FES.dbo.barcode_sub_type1 where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type1']; ?>">
                                                    <?php echo $row['sub_type1'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub2" id="sub2" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type2, sub_type2, WH FROM FES.dbo.barcode_sub_type2 where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type2']; ?>">
                                                    <?php echo $row['sub_type2'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub3" id="sub3" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type3, sub_type3, TP FROM FES.dbo.barcode_sub_type3 where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type3']; ?>">
                                                    <?php echo $row['sub_type3'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub4" id="sub4" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type4, sub_type4, WH FROM FES.dbo.barcode_sub_type4 where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type4']; ?>">
                                                    <?php echo $row['sub_type4'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub5" id="sub5" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type5, sub_type5, TP FROM FES.dbo.barcode_sub_type5 where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type5']; ?>">
                                                    <?php echo $row['sub_type5'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sub6" id="sub6" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6, WH FROM FES.dbo.barcode_sub_type6 where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type6']; ?>">
                                                    <?php echo $row['sub_type6'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="immigration_uom" id="immigration_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="barcode_type" id="immagration_barcode_type" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, UT FROM FES.dbo.barcode_product_type where IM = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="immigration_unit_price" id="immigration_unit_price"
                                            class="form-control" style="text-align:right;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" style="width:100px" class="btn btn-success" id="immigration_add"
                                    data-bs-target="#">
                                    <i class="fa fa-plus-square"></i> Add
                                </button>
                                ...
                                <button type="button" style="width:100px" class="btn btn-danger" id="immigration_cancel"
                                    data-bs-target="#">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                ...
                <div class="tab-pane fade" id="warehouse-tab">
                    <form id="warehouse_data" class="mt-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contract_line_number"
                                            id="warehouse_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Description</span><span style="color:red"> *</span>
                                        <input type="text" name="description" id="warehouse_description"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_service" id="warehouse_barcode_service"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Location</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="barcode_location" id="warehouse_barcode_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="barcode_branch" id="warehouse_barcode_branch" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            ...
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['code_branch'] ?>"
                                                    value="<?php echo $row['code_branch']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub1</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub1" id="warehouse_sub1" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub2</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub2" id="warehouse_sub2" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub3</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub3" id="warehouse_sub3" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub4</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub4" id="warehouse_sub4" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub5</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub5" id="warehouse_sub5" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub6" id="warehouse_sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="uom" id="warehouse_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="warehouse_barcode_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group d-flex flex-column " style="height:100%;">
                                        ...
                                        <input type="checkbox" value="1" id="warehouse_fixed_space" name="fixed_space"
                                            class="form-check">
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="charge_per_unit" id="warehouse_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="minimum_qty" id="warehouse_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="minimum_charge_amount"
                                            id="warehouse_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_reference" id="warehouse_customer_reference"
                                            class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success" id="warehouse-submit"
                                    data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-plus-square"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="warehouse-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success" id="warehouse-update"
                                    data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger" id="warehouse-cancel"
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="warehouse-add"
                ...
                <div class="tab-pane fade" id="utilities-tab">
                    <form id="utilities_data" class="mt-4  mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="utilities_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_service" id="utilities_barcode_service"
                                            class="form-control" required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_location" id="utilities_barcode_location"
                                            class="form-control" required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_branch" id="utilities_barcode_branch" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch,branch_name FROM FES.dbo.barcode_branch ";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub1" id="utilities_sub1" class="form-control" required
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub2" id="utilities_sub2" class="form-control" required
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub3" id="utilities_sub3" class="form-control" required
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red"> *</span>
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub6" id="utilities_sub6" class="form-control" required
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6,UT FROM FES.dbo.barcode_sub_type6 where UT = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_sub_type6']; ?>">
                                                    <?php echo $row['sub_type6'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="uom" id="utilities_uom" class="form-control" required
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="barcode_type" id="utilities_barcode_type" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="utilities_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="utilities_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="utilities_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="utilities-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success" id="utilities-update"
                                    data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger" id="utilities-cancel"
                                    data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="utilities-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                ...
                <div class="tab-pane fade" id="retal-tab">
                    <form id="retal_data" class="mt-4 mb-4">
                        <div id="retal_data_area">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number" id="retal_contract_line_number"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Description</span><span style="color:red"> *</span>
                                        <input type="text" name="description" id="retal_description"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="location" id="transport_branch" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where RN = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub1" id="retal_sub1" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub2" id="retal_sub2" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="sub6" id="retal_sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="uom" id="retal_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_operator to service_operator
                                        ?>
                                        <select name="barcode_type" id="retal_barcode_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name, BS FROM FES.dbo.barcode_product_type where RN = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Vehicle type</span><span style="color:red"> *</span>
                                        <select name="vehicle_type" id="retal_vehicle_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM vehicle_type order by code ";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="retal_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="retal_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="retal_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button type="button" style="width:100px" class="btn btn-danger" id="retal-cancel_add"
                                    data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success" id="retal-update"
                                    data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger" id="retal-cancel"
                                    data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="retal-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                ...
                <div class="tab-pane fade" id="hotelbooking-tab">
                    <form id="hotelbooking_data" class="mt-4 mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="hotelbooking_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_service" id="hotelbooking_barcode_service"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <select name="barcode_branch" id="hotelbooking_barcode_branch"
                                            class="form-control" aria-describedby="inputGroupPrepend2"
                                            onchange="changeLocation(id)" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where BS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_location" id="hotelbooking_barcode_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, RN FROM FES.dbo.barcode_location where BS = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="price_from_date" id="hotelbooking_price_from_date"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="price_to_date" id="hotelbooking_price_to_date"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="hotelbooking_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="hotelbooking_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="hotelbooking_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_reference"
                                            id="hotelbooking_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="hotelbooking-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-plus-square"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="hotelbooking-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success"
                                    id="hotelbooking-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="hotelbooking-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="hotelbooking-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                ...
                <div class="tab-pane fade" id="ticketbooking-tab">
                    <form id="ticketbooking_data" class="mt-4 mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="ticketbooking_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_service" id="ticketbooking_barcode_service"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, [group] FROM FES.dbo.barcode_service where [group] = 'BS'";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_location" id="ticketbooking_barcode_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, RN FROM FES.dbo.barcode_location where BS = 1";
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="airline_name" id="ticketbooking_airline_name" class="form-control"
                                            required aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="ticketbooking-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-plus-square"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="ticketbooking-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success"
                                    id="ticketbooking-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="ticketbooking-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="ticketbooking-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                ...
                <div class="tab-pane fade" id="serviceother-tab">
                    <form id="serviceother_data" class="mt-4 mb-4">
                        <div id="serviceother_data_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="serviceother_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_service" id="retal_barcode_service" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, [group] FROM FES.dbo.barcode_service where [group] = 'SO'";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_service']; ?>">
                                                    <?php echo $row['type_service_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="location" id="transport_branch" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where SO = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_location" id="retal_barcode_location" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, RN FROM FES.dbo.barcode_location where SO = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="serviceother_barcode_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name  FROM FES.dbo.barcode_product_type where SO = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Position</span>
                                        <input type="text" name="position" id="serviceother_position"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Vehicle Type</span><span style="color:red"> *</span>
                                        <select name="vehicle_type" id="serviceother_vehicle_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM vehicle_type order by code ";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="from_contract_location" id="serviceother_from_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="to_contract_location" id="serviceother_to_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * from contract_location_master where active = 1 ";
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel from</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_from" id="serviceother_diesel_from"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel to</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_to" id="serviceother_diesel_to"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="serviceother_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="serviceother_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="serviceother_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference </span>
                                        <input type="text" name="customer_reference"
                                            id="serviceother_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="serviceother-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="serviceother-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success"
                                    id="serviceother-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="serviceother-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="serviceother-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                        <table id="serviceother_table" class="table table-striped display nowrap ">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" width="10%"></th>
                                    <th scope="col">Contract line number</th>
                                    ...
                                    <th scope="col">Diesel from</th>
                                    <th scope="col">Diesel to</th>
                                    <th scope="col">UOM</th>
                                    <th scope="col">Charge per unit</th>
                                    <th scope="col">Minimum QTY</th>
                                    <th scope="col">Minimum Charge Amount</th>
                ...
                <div class="tab-pane fade" id="agencyservice-tab">
                    <form id="agencyservice_data" class="mt-4 mb-4">
                        <div id="agencyservice_data_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="agencyservice_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_service" id="retal_barcode_service" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, [group] FROM FES.dbo.barcode_service where [group] = 'AG'";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_service']; ?>">
                                                    <?php echo $row['type_service_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <select name="barcode_branch" id="agencyservice_barcode_branch"
                                            class="form-control" aria-describedby="inputGroupPrepend2"
                                            onchange="changeLocation(id)" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where AG = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_location" id="agencyservice_barcode_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, RN FROM FES.dbo.barcode_location where AG = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="agencyservice_barcode_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>From</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="from_contract_location" id="agencyservice_from_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name FROM FES.dbo.barcode_location where AG = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>To</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="to_contract_location" id="agencyservice_to_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name FROM FES.dbo.barcode_location where AG = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel from</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_from" id="agencyservice_diesel_from"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel to</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_to" id="agencyservice_diesel_to"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="agencyservice_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="agencyservice_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="agencyservice_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference </span>
                                        <input type="text" name="customer_reference"
                                            id="agencyservice_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="agencyservice-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="agencyservice-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success"
                                    id="agencyservice-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="agencyservice-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="agencyservice-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                        <table id="agencyservice_table" class="table table-striped display nowrap ">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" width="10%"></th>
                                    <th scope="col">Contract line number</th>
                ...
                <div class="tab-pane fade" id="managementfee-tab">
                    <form id="managementfee_data" class="mt-4 mb-4">
                        <div id="managementfee_data_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="managementfee_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Description</span><span style="color:red"> *</span>
                                        <input type="text" name="description" id="managementfee_description"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_service" id="managementfee_barcode_service"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, [group] FROM FES.dbo.barcode_service where [group] = 'SO'";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <select name="barcode_branch" id="managementfee_barcode_branch"
                                            class="form-control" aria-describedby="inputGroupPrepend2"
                                            onchange="changeLocation(id)" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub1</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub1" id="managementfee_sub1" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type1, sub_type1 FROM FES.dbo.barcode_sub_type1 where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub2</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub2" id="managementfee_sub2" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type2, sub_type2 FROM FES.dbo.barcode_sub_type2 where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub3</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub3" id="managementfee_sub3" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type3, sub_type3 FROM FES.dbo.barcode_sub_type3 where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub4</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub4" id="managementfee_sub4" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type4, sub_type4 FROM FES.dbo.barcode_sub_type4 where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub5</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub5" id="managementfee_sub5" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type5, sub_type5 FROM FES.dbo.barcode_sub_type5 where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub6" id="managementfee_sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_sub_type6, sub_type6 FROM FES.dbo.barcode_sub_type6 where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="uom" id="managementfee_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="managementfee_barcode_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name  FROM FES.dbo.barcode_product_type where SO = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Position</span>
                                        <input type="text" name="position" id="managementfee_position"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Vehicle Type</span><span style="color:red"> *</span>
                                        <select name="vehicle_type" id="managementfee_vehicle_type" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM vehicle_type order by code ";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>From</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="from_contract_location" id="managementfee_from_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name FROM FES.dbo.barcode_location where SO = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>To</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="to_contract_location" id="managementfee_to_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name FROM FES.dbo.barcode_location where SO= 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel from</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_from" id="managementfee_diesel_from"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel to</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_to" id="managementfee_diesel_to"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="managementfee_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="managementfee_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="managementfee_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference </span>
                                        <input type="text" name="customer_reference"
                                            id="managementfee_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="managementfee-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="managementfee-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success"
                                    id="managementfee-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="managementfee-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="managementfee-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                        <table id="managementfee_table" class="table table-striped display nowrap ">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" width="10%"></th>
                                    <th scope="col">Contract line number</th>
                ...
                <div class="tab-pane fade" id="provisionincome-tab">
                    <form id="provisionincome_data" class="mt-4 mb-4">
                        <div id="provisionincome_data_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="provisionincome_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <?php //switch transport_vehicle to service_vehicle
                                        ?>
                                        <select name="barcode_service" id="provisionincome_barcode_service"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <select name="barcode_branch" id="provisionincome_barcode_branch"
                                            class="form-control" aria-describedby="inputGroupPrepend2"
                                            onchange="changeLocation(id)" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where PV = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_location" id="retal_barcode_location" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, RN FROM FES.dbo.barcode_location where PV = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="provisionincome_barcode_type"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>From</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="from_contract_location"
                                            id="provisionincome_from_contract_location" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name FROM FES.dbo.barcode_location where PV = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>To</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="to_contract_location" id="provisionincome_to_contract_location"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name FROM FES.dbo.barcode_location where PV = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel from</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_from" id="provisionincome_diesel_from"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Diesel to</span><span style="color:red"> *</span>
                                        <input type="number" name="diesel_to" id="provisionincome_diesel_to"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit" id="provisionincome_charge_per_unit"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="provisionincome_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="provisionincome_minimum_charge_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference </span>
                                        <input type="text" name="customer_reference"
                                            id="provisionincome_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="provisionincome-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="provisionincome-cancel_add" data-bs-target="#" onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>


                                <button type="button" style="display:none" class="btn btn-success"
                                    id="provisionincome-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="provisionincome-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4" id="provisionincome-add"
                        data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                ...
                <div class="tab-pane fade" id="customerclearancevessle-tab">
                    <form id="customerclearancevessle_data" class="mt-4 mb-4">
                        <div id="customerclearancevessle_data_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="customerclearancevessle_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <span>Description</span><span style="color:red"> *</span>
                                        <input type="text" name="description" id="customerclearancevessle_description"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Branch</span><span style="color:red"> *</span>
                                        <select name="branch" id="customerclearancevessle_branch" class="form-control"
                                            aria-describedby="inputGroupPrepend2" onchange="changeLocation(id)"
                                            required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT code_branch, branch_name, TP FROM FES.dbo.barcode_branch where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['branch_name']; ?>">
                                                    <?php echo $row['branch_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select name="barcode_location" id="retal_barcode_location" class="form-control"
                                            ...
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_location, location_name, RN FROM FES.dbo.barcode_location where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option id="<?php echo $row['location_name'] ?>"
                                                    value="<?php echo $row['no_location']; ?>">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub1</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub1" id="customerclearancevessle_sub1" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub2</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub2" id="customerclearancevessle_sub2" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub3</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub3" id="customerclearancevessle_sub3" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub4</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub4" id="customerclearancevessle_sub4" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub5</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub5" id="customerclearancevessle_sub5" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Sub6</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="sub6" id="customerclearancevessle_sub6" class="form-control"
                                            aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>UOM</span><span style="color:red"> *</span>
                                        <select name="uom" id="customerclearancevessle_uom" class="form-control"
                                            aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT * FROM uom";
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="customerclearancevessle_barcode_type"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name  FROM FES.dbo.barcode_product_type where CH = 1";
                                            $result = sqlsrv_query($conn, $fQuery);
                                            while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                                                <option value="<?php echo $row['no_product_type']; ?>">
                                                    <?php echo $row['product_type_name'] ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Vessel Type</span><span style="color:red"> *</span>
                                        <select name="vessel_type" id="customerclearancevessle_vessel_type"
                                            class="form-control" aria-describedby="inputGroupPrepend2" required>
                                            <option value=""></option>
                                            <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit"
                                            id="customerclearancevessle_charge_per_unit" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="customerclearancevessle_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="customerclearancevessle_minimum_charge_amount" class="form-control"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference </span>
                                        <input type="text" name="customer_reference"
                                            id="customerclearancevessle_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="customerclearancevessle-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="customerclearancevessle-cancel_add" data-bs-target="#"
                                ...
                                <button type="button" style="display:none" class="btn btn-success"
                                    id="customerclearancevessle-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="customerclearancevessle-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4"
                        id="customerclearancevessle-add" data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
                        <table id="customerclearancevessle_table" class="table table-striped display nowrap "
                            style="width:100%">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" width="10%"></th>
                ...
                <div class="tab-pane fade" id="customerclearancecargo-tab">
                    <form id="customerclearancecargo_data" class="mt-4 mb-4">
                        <div id="customerclearancecargo_data_area">
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Contract line number</span>
                                        <input type="text" name="contract_line_number"
                                            id="customerclearancecargo_contract_line_number" class="form-control">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <span>Name</span><span style="color:red"> *</span>
                                        <?php //switch transport_vehicle to service_vehicle ?>
                                        <select name="barcode_service" id="customerclearancecargo_barcode_service"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_service, type_service_name, [group] FROM FES.dbo.barcode_service where [group] = 'CH'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Type</span><span style="color:red">
                                            *</span><?php //switch transport_operator to service_operator ?>
                                        <select name="barcode_type" id="customerclearancecargo_barcode_type"
                                            class="form-control" aria-describedby="inputGroupPrepend2">
                                            <option value=""></option>
                                            <?php
                                            $fQuery = "SELECT no_product_type, product_type_name  FROM FES.dbo.barcode_product_type where CH = 1";
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Weight from</span><span style="color:red"> *</span>
                                        <input type="number" name="weight_from" id="customerclearancecargo_weight_from"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Weight to</span><span style="color:red"> *</span>
                                        <input type="number" name="weight_to" id="customerclearancecargo_weight_to"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Charge per unit</span><span style="color:red"> *</span>
                                        <input type="number" name="charge_per_unit"
                                            id="customerclearancecargo_charge_per_unit" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Qty</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_qty" id="customerclearancecargo_minimum_qty"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Minimum Charge Amount</span><span style="color:red"> *</span>
                                        <input type="number" name="minimum_charge_amount"
                                            id="customerclearancecargo_minimum_charge_amount" class="form-control"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <span>Customer reference </span>
                                        <input type="text" name="customer_reference"
                                            id="customerclearancecargo_customer_reference" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" style="width:100px" class="btn btn-success"
                                    id="customerclearancecargo-submit" data-bs-target="#" onclick="submitform(id)">
                                    <i class="fa fa-save"></i> Save
                                </button>

                                <button type="button" style="width:100px" class="btn btn-danger"
                                    id="customerclearancecargo-cancel_add" data-bs-target="#"
                                    onclick="cancleAddForm(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                                ...
                                <button type="button" style="display:none" class="btn btn-success"
                                    id="customerclearancecargo-update" data-bs-target="#" onclick="updateJob(id)">
                                    <i class="fa fa-save"></i> Update
                                </button>

                                <button type="button" style="display:none" class="btn btn-danger"
                                    id="customerclearancecargo-cancel" data-bs-target="#" onclick="cancleUpdate(id)">
                                    <i class="fa fa-minus-square"></i> Cancel
                                </button>
                    ...
                    <button type="button" style="width:100px" class="btn btn-success mt-4 mb-4"
                        id="customerclearancecargo-add" data-bs-target="#" onclick="showForm(id)">
                        <i class="fa fa-plus-square"></i> Add
                    </button>
                    <div class="table-responsive">
...
<script>
    ...
    function load_contract(contract_no) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#round_trip_rate').val(parseFloat(data.round_trip_rate).toFixed(2));
    ...
    $("#menu-contract a.nav-link").on('click', function (event) {
        ...
        $("#" + form[0] + "_data").hide();
        $("#" + form[0] + "-add").show();
        if (document.getElementById(form[0] + "_add")) {
            $("#" + form[0] + "_data").show();
        }
    ...
    function countRowJob(worksheet) {
        const menujob = document.getElementById('menu-contract');
        const listItems = menujob.getElementsByTagName('a');
        const arrTable = {
            "transportation-nav": 'contract_transportation_rate',
            "service-nav": 'contract_service_rate',
            "hourly-nav": 'contract_hourly_rate',
            "heavy-nav": 'contract_equipment_rental',
            "immigration-nav": 'contract_immigration',
            "taxi-nav": 'contract_taxi_service',
            "warehouse-nav": 'contract_warehousing_space_rental',
            "utilities-nav": 'contract_utilities',
            "retal-nav": 'contract_rental',
            "hotelbooking-nav": 'contract_hotel_booking',
            "ticketbooking-nav": 'contract_ticket_booking',
    ...
    function submitform(formname) {
        ...
        if (formName) {
            ...
            $(name).submit(function (e) {
                ...
                var $form = $(name);
                var dataForm = getFormData($form);
                const contract_no = document.getElementById('contract_no');
                const customer_code = document.getElementById('customer_no');
                if (customer_code.value || contract_no) {
                    dataForm['contract_no'] = contract_no.value;
    ...
    function getDatatoTable(tab) {
        ...
        // console.log(tabName[0])
        var divTable = document.getElementById(tabtable);
        if (divTable) {
            var api = "api/view_contract_job.php?id=" + $('#contract_no').val() + "&job=" + tabName[0];
    ...
    function get_Details(id, type) {
        ...
        if (contract_no) {
            $.ajax({
                type: 'GET',
                dataType: "json",
                url: 'api/get_details_contract.php?id=' + id + '&type=' + type + '&contract_no=' + contract_no.value,
                success: function (res) {
                    if (res) {
    ...
    $('#transportation_table tbody').on('click', 'button.editbtn', function () {
        ...
        $("#vehicle_type1").val(data[3]);
        $("#diesel_baht_from").val(Number(data[4]).toFixed(2));
        $("#diesel_baht_to").val(Number(data[5]).toFixed(2));
        $("#transportation_rate").val(Number(data[8]).toFixed(2));
        $("#transportation_from").val(data[6]);
        $("#transportation_to").val(data[7]);
        $("#total_km").val(data[9]);
        $("#transportation_uom").val(data[11]);
        $("#transport_category").val(data[12]);
        $("#transport_sub1").val(data[20]);
        $("#transport_sub2").val(data[21]);
        $("#transport_sub3").val(data[22]);
        $("#transport_sub4").val(data[23]);
        $("#transport_sub5").val(data[24]);
        $("#transport_sub6").val(data[25]);
        ...
        $("#transportation_reccode").val(data[0]);
        $("#transportation_round_trip_rate").val(data[13]);
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        type: 'GET',
                        dataType: "json",
                        url: 'api/delete_contract_service_rate.php?reccode=' + data[0],
                        success: function (data) {
    ...
    $('#hourly_table tbody').on('click', 'button.editbtn', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#hourly_contract_line_number").val(data.contract_line);
