<div class="modal-body"> 
    ...
    <form action="" method="POST" role="form" id="uom_data">
        <div class="row">  
            <div class="col-3">   
...
<script>
    $("#uom_data").submit(function(e) {
        e.preventDefault();
        var $form = $("#uom_data");
        var data = getFormData($form);
        $("#uom_submit").prop("disabled",true);
    ...
    function insert_data(data){
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: 'api/insert_uom.php',
            data: data,
            success: function(data) {
                $("#uom_submit").prop("disabled",false);
    ...
    function load_uom(code){
        $.ajax({
            type: 'GET',
            dataType: "json",
            url: 'api/get_uom.php?code='+code,
            success: function(data) {
                $('#code').val(data.code);
    ...
    function clear_data(){
        $('form#uom_data input:checkbox').prop('checked', false);
        $('form#uom_data input:text').val('');
        $("#uom_submit").prop("disabled",false);
    }
</script>