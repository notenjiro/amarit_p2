  ...
  <div class="modal fade" id="vieweditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <?php include "modal/1.9_edit.php"?>
            </div>
        </div>
    </div>
                    ...
                    <table id="location_table" class="table table-striped" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
								...
								<th scope="col" style="width: 5%;">Zipcode</th>
								<th scope="col" style="width: 20%;">Department</th>
                                <th scope="col" style="width: 20%;">Cost Center</th>
                            </tr>
                        </thead>                       
                        <tbody>  
                        </tbody>
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: 'GET',
                            dataType: "json",
                            url: 'api/delete_location.php?code='+data[0],
