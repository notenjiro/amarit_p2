  ...
  <div class="modal fade" id="vieweditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <?php include "modal/1.4_edit.php"?>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="row d-flex">
                    ...
                    <div class="ml-3">  
                        ...
                        <script>init('vehicle_type');</script>
                    ...
                    <table id="vehicle_type_table" class="table table-striped" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" style="width: 20%;">Fuel ratio</th>
								<th scope="col" style="width: 20%;">Vehicle Group</th>
                            </tr>
                        </thead>                       
                        <tbody>  
                        </tbody>
    ...
    <script>
        $(document).ready(function(){
            var table = $('#vehicle_type_table').DataTable( {
                "ajax": "api/view_vehicle_type.php",
                "columnDefs": [ {
                    "targets": 0,
                    "data": null,
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: 'GET',
                            dataType: "json",
                            url: 'api/delete_vehicle_type.php?code='+data[0],
