...
END;
    ...
    $col_data = [
        ...
        "col_6" => [($row["col_6"]==""?"-":$row["col_6"])],[($row["col_6-1"]==""?"-":$row["col_6-1"])],
        "col_7" => [($row["col_7"]==""?"-":$row["col_7"])],[($row["col_7-1"]==""?"-":$row["col_7-1"])],
    ];
    ...
    $row_detail = [
		...
		$set_cell_2 = array(
            ...
            $x = 10;
            $y=$y+($service_id==0?36:30);

            $pdf->SetXY($set_x,$set_y=$set_y+5);
            $pdf->Cell(5,($service_id==0?24:18),iconv( 'UTF-8','TIS-620',""),(($i+1)%3==0||$i==0?"LB":"L"),0,"C");
            $pdf->SetXY($set_x+5,$set_y);
            $pdf->Cell(185,($service_id==0?24:18),iconv( 'UTF-8','TIS-620',""),(($i+1)%3==0||$i==0?"LBR":"LR"),0,"C");
        ...
        if($service_id==0){
            ...
            $pdf->TextLength50CanPossibleOrNot(1,60,$row_detail[3][0],$row_detail[3][1]);
            $pdf->SetXY($set_x=$set_x+60,$set_y);
            $pdf->TextLength50CanPossibleOrNot(1,60,$row_detail[4][0],$row_detail[4][1]);
            $pdf->SetXY($set_x=$set_x+60,$set_y);
            $pdf->TextLength50CanPossibleOrNot(1,60,$row_detail[5][0],$row_detail[5][1]);
...
///////////////////////////////// worksheet_utilities 
	...
	WHERE
	dbo.worksheet_utilities.worksheet_id = '$worksheet_id' and \"status\" <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
...
///////////////////////////////// worksheet_hotel_booking 
	...
	WHERE
	dbo.worksheet_hotel_booking.worksheet_id = '$worksheet_id' and \"status\" <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
...
WHERE
	dbo.worksheet_warehousing_space_rental.worksheet_id = '$worksheet_id' and \"status\" <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
...
///////////////////////////////// worksheet_rental 
	...
	WHERE
	dbo.worksheet_rental.worksheet_id = '$worksheet_id' and \"status\" <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
...
//-- Transportation
    ...
    WHERE worksheet_id = '$worksheet_id' and line_status <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
    ...
    WHERE worksheet_id = '$worksheet_id' AND no_charge = 0 and line_status <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
...
//-- Agency Service
    ...
    WHERE worksheet_id = '$worksheet_id' and status <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
	...
	AND (no_charge <> 1 or no_charge is null)
	";
...
///////////////////////////////// worksheet_customer_clearance_cargo 
	...
	WHERE
	dbo.worksheet_customer_clearance_cargo.worksheet_id = '$worksheet_id' and \"status\" <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
    ...
    while($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)){
		...
		$pdf->SetXY($line_x+20,$line_y);
		$pdf->Cell(30,6,iconv( 'UTF-8','TIS-620',"-"),"TR",0,"C");
		$line_x=$pdf->GetX();
		$pdf->MultiCell(25,6,iconv( 'UTF-8','TIS-620',$row["description"]),"TR","C");
		$pdf->SetXY($line_x+25,$line_y);
		//$pdf->Cell(30,6,iconv( 'UTF-8','TIS-620',$row["specific_location_to"]),"TR",0,"C");
		// if (is_null($row["actual_start_date"]) )
		// 	$pdf->Cell(20,6,iconv( 'UTF-8','TIS-620',date_format($row["start_date"],"d-M-y")),"RT",0,"C");
...
///////////////////////////////// worksheet_customer_clearance_vessel 
	...
	WHERE
	dbo.worksheet_customer_clearance_vessel.worksheet_id = '$worksheet_id' and \"status\" <> 'Cancelled' AND (no_charge <> 1 or no_charge is null)";
    $stmt = sqlsrv_query($conn, $iquery);
