  ...
  <div class="modal fade" id="vieweditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Type 5</h5>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row d-flex">
                    <div class="ml-3">  
						Type 5
                        <button style="width:100px" type="button" class="btn btn-success" id="type5_add" data-bs-target="#" >
        ...
        <div class="card">
            <div class="card-body">   
                ...
                <div class="card-body">  
                    <table id="type5_table" class="table table-striped" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="width: 10%;">Cost Center</th>
                            </tr>
                        </thead>                       
                        <tbody>  
                        </tbody>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#type5_table tbody').on( 'click', 'button.deletebtn', function () {
                var table = $('#type5_table').DataTable();
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: 'GET',
                            dataType: "json",
                            url: 'api/delete_type5.php?code='+data[0],
                            success: function(data) {
                                $('#type5_table').DataTable().ajax.reload();
                                Result = data;
             ...
             $('#type5_table tbody').on( 'click', 'button.editbtn', function () {
                var table = $('#type5_table').DataTable();
                var data = table.row( $(this).parents('tr') ).data();
                load_type(data[0]);
            ...
            $('#type5_table tbody').on( 'click', 'button.infobtn', function () {
                var table = $('#type5_table').DataTable();
                var data = table.row( $(this).parents('tr') ).data();
                load_type(data[0]);
                $('#form_type').val(''); 
