        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Contract location</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
                </div>
                <?php include "modal/1.44_edit.php"?>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="row d-flex">
                    ...
                    <div class="ml-3">  
                        ...
                        <script>init('contract_location_master');</script>
                    ...
                    <table id="location_table" class="table table-striped" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
								...
								<th scope="col" style="width: 25%;">Province</th>
    ...
    <script>
        $(document).ready(function(){
            var table = $('#location_table').DataTable( {
                "ajax": "api/view_contract_location_master.php",
                "columnDefs": [ {
                    "targets": 0,
                    "data": null,
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: 'GET',
                            dataType: "json",
                            url: 'api/delete_contract_location_master.php?code='+data[0],
