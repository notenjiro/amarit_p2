  ...
  <div class="tab-content">
	...
	<div class="row" style="margin-bottom:20px;"> 
		<div class="col-xs-12 col-sm-12 col-md-12 ">
			<br>
	          <a id="fademore" class="fademore">More Info <i class="fas fa-caret-right"></i><i class="fas fa-caret-down"></i></a> 
        </div>
    </div>
	</div>
		  ...
		  <h5 class="modal-title" id="classModalLabel">-</h5>
        <table id="letter_person_table" class="table table-striped display nowrap" style="width:100%">
			<thead>
			<tr>
				<th>Transport ID</th>
				<th>Vehicle</th>
