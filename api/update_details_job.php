...
$id = $data[$arrCheckBy[$type]];
unset($data->$arrCheckBy[$type]);
...
$fQuery = "UPDATE $table[$type] SET $column   WHERE $arrCheckBy[$type] = '$id'  and worksheet_id = '$worksheet_id'";
