...
$fQuery = "SELECT * FROM job_warehousing_space_rental WHERE reccode = '$reccode'";
...
$raw['WarehousingSpace_id'] = $row['warehousing_space_rental_id'];
...
$raw['type1'] = $row['type1'];
$raw['type2'] = $row['type2'];
$raw['fixed_space'] = $row['fixed_space'];
