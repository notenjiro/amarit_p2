...
$fQuery = "SELECT * FROM job_hotel_booking WHERE reccode = '$reccode'";
...
$raw['hotel_booking_id'] = $row['hotel_booking_id'];
...
$raw['hotel_name'] = $row['hotel_name'];
$raw['P_O'] = $row['passenger_occupation'];
$raw['des2'] = $row['description2'];
$raw['type'] = $row['room_type'];
$raw['meal'] = $row['meal_include'];
$raw['laundry'] = $row['laundry_include'];
