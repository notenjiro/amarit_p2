...
//$fQuery = "SELECT count(1) as num FROM worksheet_manpower where worksheet_id = '$worksheet_id'";
...
$fQuery = "SELECT count(1) as num FROM worksheet_manpower where worksheet_id like '$ws'";
