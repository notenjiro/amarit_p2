  ...
  <div class="modal fade" id="vieweditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <?php include "modal/1.33_edit.php"?>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row d-flex">
                    <div class="ml-3">  
						Subject
                        <button style="width:100px" type="button" class="btn btn-success" id="subject_add" data-bs-target="#" >
        ...
        <div class="card">
            <div class="card-body">   
                ...
                <div class="card-body">  
                    <table id="subject_table" class="table table-striped" style="width: 100%;">
                        <thead>
                            <tr>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#subject_table tbody').on( 'click', 'button.deletebtn', function () {
                var table = $('#subject_table').DataTable();
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: 'GET',
                            dataType: "json",
                            url: 'api/delete_subject.php?code='+data[0],
             ...
             $('#subject_table tbody').on( 'click', 'button.editbtn', function () {
                var table = $('#subject_table').DataTable();
                var data = table.row( $(this).parents('tr') ).data();
                load_subject(data[0]);
            ...
            $('#subject_table tbody').on( 'click', 'button.infobtn', function () {
                var table = $('#subject_table').DataTable();
                var data = table.row( $(this).parents('tr') ).data();
                load_subject(data[0]);
                $('#form_type').val(''); 
                ...
                $('#subject_data input').attr('readonly', 'readonly');
                $('#subject_data select').attr('readonly', 'readonly');
                $('#subject_data input:checkbox').prop("disabled",true);
                $('#subject_data button').hide();
            });
        });
    </script>
