...
<body>
  ...
  <div class="container">
	...
	<tbody>
	  <tr>
	    <td scope"col">1</td>
	    <td scope"col">F1.5</td>
	    <td scope"col">Froklift 1.5 Tons</td>
	  ...
	  <tr>
	    <td scope"col">2</td>
	    <td scope"col">F2.5</td>
	    <td scope"col">Froklift 2.5 Tons</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">3</td>
	    <td scope"col">F3</td>
	    <td scope"col">Froklift 3 Tons</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">4</td>
	    <td scope"col">F3.5</td>
	    <td scope"col">Froklift 3.5 Tons</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
