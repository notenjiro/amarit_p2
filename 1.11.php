  ...
  <div class="modal fade" id="vieweditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Driver & Operator & Manpower</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
                </div>
                <?php include "modal/1.11_edit.php"?>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row d-flex">
                    <div class="ml-3">  
						Driver & Operator & Manpower
                        <button style="width:100px" type="button" class="btn btn-success" id="operator_add" data-bs-target="#" >
        ...
        <div class="card">
            <div class="card-body">   
                ...
                <div class="card-body">  
                    <table id="operator_table" class="table table-striped" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" style="width: 10%;">Day Off</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#operator_table tbody').on( 'click', 'button.deletebtn', function () {
                var table = $('#operator_table').DataTable();
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: 'GET',
                            dataType: "json",
                            url: 'api/delete_operator.php?operator_id='+data[0],
             ...
             $('#operator_table tbody').on( 'click', 'button.editbtn', function () {
                var table = $('#operator_table').DataTable();
                var data = table.row( $(this).parents('tr') ).data();
            ...
            $('#operator_table tbody').on( 'click', 'button.infobtn', function () {
                var table = $('#operator_table').DataTable();
                var data = table.row( $(this).parents('tr') ).data();
                load_operator(data[0]);
                $('#form_type').val(''); 
                ...
                $('#operator_data input').attr('readonly', 'readonly');
                $('#operator_data select').attr('readonly', 'readonly');
                $('#operator_data input:checkbox').prop("disabled",true);
                $('#operator_data button').hide();
            });
        });
    </script>
