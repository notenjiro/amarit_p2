...
<body>
  ...
  <div class="container">
	...
	<tbody>
	  <tr>
	    <td scope"col">1</td>
	    <td scope"col">LB00001</td>
	    <td scope"col">Aekkarat P.</td>
	  ...
	  <tr>
	    <td scope"col">2</td>
	    <td scope"col">LB00002</td>
	    <td scope"col">Amorn S.</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">4</td>
	    <td scope"col">LB00004</td>
	    <td scope"col">Ampai T.</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
		  ...
		  <div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
		      <div class="field">
		        <label>Skill</label>
		        <select id="type" name="type" class="form-control">
					<option value="1">Driver 10 Wheels Truck</option>
					<option value="2">Driver 6 Wheels Truck</option>
				</select>
    	      </div>
			</div>	
			<div class="col-xs-12 col-sm-6 col-md-2">
