  ...
  <div class="container">
	...
	<tbody>
	  <tr>
	    ...
	    <td scope"col">1.1.Customer master</td>
	    <td scope"col">Y</td>
	    <td scope"col">Y</td>
		<td scope"col">Y</td>
	    <td scope"col">Y</td>
	  ...
	  <tr>
		<td scope"col">2</td>
		<td scope"col">admin</td>
	    <td scope"col">1.2.Vehicle Master</td>
	    <td scope"col">Y</td>
	    <td scope"col">Y</td>
		<td scope"col">N</td>
	    <td scope"col">Y</td>
	  ...
	  <tr>
		<td scope"col">3</td>
		<td scope"col">admin</td>
	    <td scope"col">1.3.Vehicle Type</td>
	    <td scope"col">Y</td>
	    <td scope"col">Y</td>
		<td scope"col">N</td>
	    <td scope"col">Y</td>
	  ...
	  <tr>
		<td scope"col">4</td>
		<td scope"col">admin</td>
	    <td scope"col">1.4.Vehicle Brand</td>
	    <td scope"col">N</td>
	    <td scope"col">N</td>
		<td scope"col">N</td>
	    <td scope"col">N</td>
		  ...
		  <div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
		      <div class="field">
		        ...
		        <select id="type" name="type" class="form-control">
					<option value="1">1.1.Customer Master</option>
					<option value="2">1.2.Vehicle Master</option>
				</select>
    	      </div>
			</div>	
