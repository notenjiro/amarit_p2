...
<body>
  ...
  <div class="container">
	...
	<thead class="thead-light">
	  ...
	  <th scope"col">Vehicle ID ERP</th>
	...
	<tbody>
	  <tr>
		<td scope"col">1</td>
	    <td scope"col">VH00089</td>
		<td scope"col"></td>
	    <td scope"col">1 กฌ 552</td>
	    <td scope"col"></td>
	  ...
	  <tr>
		<td scope"col">2</td>
	    <td scope"col">VH00091</td>
		<td scope"col"></td>
	    <td scope"col">1 กฌ 580</td>
	    <td scope"col"></td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	  ...
	  <tr>
		<td scope"col">3</td>
	    <td scope"col">VH00035</td>
		<td scope"col"></td>
	    <td scope"col">FL10TON 30G00743</td>
	    <td scope"col">F-01</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
		<td scope"col">4</td>
	    <td scope"col">VH00034</td>
		<td scope"col"></td>
	    <td scope"col">FL10TON 2FD115-10059</td>
	    <td scope"col">F-02</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
			...
			<div class="col-xs-12 col-sm-6 col-md-2">
		      <div class="field">
		        ...
		        <select id="type" name="type" class="form-control">
					...
					<option value="1">20 ton</option>
					<option value="1">50 ton</option>
					<option value="1">70 ton</option>
					<option value="1">100 ton</option>
				</select>
			  </div>
    	    </div>
			<div class="col-xs-12 col-sm-6 col-md-2">
		      <div class="field">
		        <label>Group</label>
		        <select id="type" name="type" class="form-control">
					<option value="1">10 wheeler</option>
