...
<body>
  ...
  <nav class="navbar text-white thead-light">
    <span class="navbar-brand mb-0 h1">
	  ...
	  More Information
	  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#b1"><i class="fa fa-id-card"></i>Contact List</button>  
    </span>
	<span class="navbar-brand mb-0 h1">
  ...
  <div class="container">
	...
	<tbody>
	  <tr>
	    ...
	    <td scope"col">CL00001</td>
	    <td scope"col">C0001</td>
	    <td scope"col">National Oilwell Varco (Thailand) Ltd.</td>
	    <td scope"col">Bangkok</td>
		<td scope"col">10900</td>
		<td scope"col">02-937-1214-6</td>
	  ...
	  <tr>
	    <td align="center"><input type="checkbox" class="form-check" id="exampleCheck1"></td>
	    <td scope"col">CL00002</td>
	    <td scope"col">C0002</td>
	    <td scope"col">ATWOOD OFFSHORE DRILLING LIMITED.</td>
	    <td scope"col">Bangkok</td>
		<td scope"col">10260</td>
		<td scope"col">02-745-7305</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td align="center"><input type="checkbox" class="form-check" id="exampleCheck1"></td>
	    <td scope"col">CL00003</td>
	    <td scope"col">C0003</td>
	    <td scope"col">Chevron Thailand Exploration and Production, Ltd.</td>
	    <td scope"col">Bangkok</td>
		<td scope"col">10900</td>
		<td scope"col">02-545-6630</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td align="center"><input type="checkbox" class="form-check" id="exampleCheck1"></td>
	    <td scope"col">CL00004</td>
	    <td scope"col">C0004</td>
	    <td scope"col">Chevron Offshore (Thailand) Ltd.</td>
	    <td scope"col">Bangkok</td>
		<td scope"col">10900</td>
		<td scope"col">02-545-6683</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td align="center"><input type="checkbox" class="form-check" id="exampleCheck1"></td>
	    <td scope"col">CL00005</td>
	    <td scope"col">C0005</td>
	    <td scope"col">Tubular Products Services Co., Ltd.</td>
	    <td scope"col">Songkhla</td>
		<td scope"col">90280</td>
		<td scope"col">074-338-588</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
