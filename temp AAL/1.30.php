  ...
  <div class="container">
	...
	<tbody>
	  <tr>
	    <td scope"col">1</td>
	    <td scope"col">R</td>
	    <td scope"col">Workday</td>
		<td scope"col">ทำงานปกติ</td>
	  ...
	  <tr>
	    ...
	    <td scope"col">วันหยุดนักขัตฤกษ์</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">3</td>
	    <td scope"col">O</td>
		<td scope"col">Day off</td>
	    <td scope"col">วันหยุด</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">4</td>
	    <td scope"col">S</td>
		<td scope"col">Sick leave</td>
	    <td scope"col">ลาป่วย</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">5</td>
	    <td scope"col">P</td>
		<td scope"col">Personal leave</td>
	    <td scope"col">ลากิจ</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">6</td>
	    <td scope"col">Y</td>
		<td scope"col">Annual leave</td>
	    <td scope"col">ลาพักผ่อนประจำปี</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">7</td>
	    <td scope"col">A</td>
		<td scope"col">Accident leave </td>
	    <td scope"col">ลาเนื่องจากอุบัติเหตุ</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
