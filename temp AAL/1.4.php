  ...
  <div class="container">
	...
	<tbody>
	  <tr>
	    <td scope"col">1</td>
	    <td scope"col">01</td>
	    <td scope"col">10 Wheeler Special Truck</td>
	  ...
	  <tr>
	    <td scope"col">2</td>
	    <td scope"col">02</td>
	    <td scope"col">10 Wheeler Truck</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">3</td>
	    <td scope"col">03</td>
	    <td scope"col">10 Wheeler Truck With Crane 3 Ton</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">4</td>
	    <td scope"col">04</td>
	    <td scope"col">6 Wheeler Special Truck</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
	  ...
	  <tr>
	    <td scope"col">5</td>
	    <td scope"col">05</td>
	    <td scope"col">6 Wheeler Truck</td>
		<td <button type="button" id="new" class="btn btn-warning" data-toggle="modal"
			date-target="#exampleModal"><i class="far fa-edit"></i>
			Edit</button></td>
	    <td <button type="button" id="new" class="btn btn-danger" data-toggle="modal"
